...
@Component
public class ManejadorCrearReserva implements ManejadorComandoRespuesta<ComandoReserva, ComandoRespuesta<DtoRespuestaReserva>> {
    ...
    public ComandoRespuesta<DtoRespuestaReserva> ejecutar(ComandoReserva comando) {
